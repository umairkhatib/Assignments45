"use strict";
//Assignment # 24
console.log("Equality Test with String :", "Umair Aziz" === "Umair Aziz");
console.log("Inequality Test with String :", "Umair Aziz" === "Kamran");
console.log("Lowercase Test : ", "UMAIR AZIZ".toLowerCase() === "umair aziz");
//Numerical Tests
console.log("Equality Test with number :", 10 === 10);
console.log("Inequality Test with number :", 10 !== 11);
...
let programing = ["GW basic", "Pascal", "C #", "Asp.net", "Typescript"];
